# Visual Blueprint: sheet charactersEquipment

- **Asset ID / Stem**: `sheet_charactersEquipment`
- **Category**: `units`
...
Synthesize a resolution-independent SVG vector graphic for "sheet charactersEquipment" (sheet_charactersEquipment) in category "units".
