# Visual Blueprint: sheet characters

- **Asset ID / Stem**: `sheet_characters`
- **Category**: `units`
...
Synthesize a resolution-independent SVG vector graphic for "sheet characters" (sheet_characters) in category "units".
