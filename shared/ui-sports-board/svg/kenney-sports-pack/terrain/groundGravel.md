# Visual Blueprint: groundGravel

- **Asset ID / Stem**: `groundGravel`
- **Category**: `terrain`
...
Synthesize a resolution-independent SVG vector graphic for "groundGravel" (groundGravel) in category "terrain".
