# Visual Blueprint: groundIce blue

- **Asset ID / Stem**: `groundIce_blue`
- **Category**: `terrain`
...
Synthesize a resolution-independent SVG vector graphic for "groundIce blue" (groundIce_blue) in category "terrain".
