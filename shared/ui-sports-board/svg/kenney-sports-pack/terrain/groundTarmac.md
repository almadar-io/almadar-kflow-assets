# Visual Blueprint: groundTarmac

- **Asset ID / Stem**: `groundTarmac`
- **Category**: `terrain`
...
Synthesize a resolution-independent SVG vector graphic for "groundTarmac" (groundTarmac) in category "terrain".
