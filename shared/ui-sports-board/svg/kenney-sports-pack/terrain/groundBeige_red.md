# Visual Blueprint: groundBeige red

- **Asset ID / Stem**: `groundBeige_red`
- **Category**: `terrain`
...
Synthesize a resolution-independent SVG vector graphic for "groundBeige red" (groundBeige_red) in category "terrain".
