# Visual Blueprint: groundTransparent white

- **Asset ID / Stem**: `groundTransparent_white`
- **Category**: `terrain`
...
Synthesize a resolution-independent SVG vector graphic for "groundTransparent white" (groundTransparent_white) in category "terrain".
