# Visual Blueprint: sheet equipment

- **Asset ID / Stem**: `sheet_equipment`
- **Category**: `terrain`
...
Synthesize a resolution-independent SVG vector graphic for "sheet equipment" (sheet_equipment) in category "terrain".
