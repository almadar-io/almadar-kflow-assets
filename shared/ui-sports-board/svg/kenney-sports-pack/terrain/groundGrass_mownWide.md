# Visual Blueprint: Mown Striped Lawn Grass Ground Block

- **Asset ID / Stem**: `groundGrass_mownWide`
- **Category**: `terrain`
...
Vibrant green top lawn surface featuring alternating vertical light green (#4CAF50) and dark green (#2E7D32) lawnmower mown stripe bands. Base block shows earthy brown dirt layers.
...
Synthesize a resolution-independent SVG vector graphic for "Mown Striped Lawn Grass Ground Block" (groundGrass_mownWide) in category "terrain".
...
Surface & Details: Vibrant green top lawn surface featuring alternating vertical light green (#4CAF50) and dark green (#2E7D32) lawnmower mown stripe bands. Base block shows earthy brown dirt layers.
