# Visual Blueprint: Lush Green Grass Ground Block

- **Asset ID / Stem**: `groundGrass`
- **Category**: `terrain`
...
Vibrant green top crust with organic grassy tufts and blades along top edge, resting on rich brown soil/dirt base block.
...
Synthesize a resolution-independent SVG vector graphic for "Lush Green Grass Ground Block" (groundGrass) in category "terrain".
...
Surface & Details: Vibrant green top crust with organic grassy tufts and blades along top edge, resting on rich brown soil/dirt base block.
