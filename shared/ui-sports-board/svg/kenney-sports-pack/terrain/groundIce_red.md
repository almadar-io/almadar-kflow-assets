# Visual Blueprint: groundIce red

- **Asset ID / Stem**: `groundIce_red`
- **Category**: `terrain`
...
Synthesize a resolution-independent SVG vector graphic for "groundIce red" (groundIce_red) in category "terrain".
