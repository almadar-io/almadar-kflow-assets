# Visual Blueprint: groundTransparent black

- **Asset ID / Stem**: `groundTransparent_black`
- **Category**: `terrain`
...
Synthesize a resolution-independent SVG vector graphic for "groundTransparent black" (groundTransparent_black) in category "terrain".
