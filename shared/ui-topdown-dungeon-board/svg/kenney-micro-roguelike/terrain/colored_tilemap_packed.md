# Visual Blueprint: colored tilemap packed

- **Asset ID / Stem**: `colored_tilemap_packed`
- **Category**: `terrain`
...
Synthesize a resolution-independent SVG vector graphic for "colored tilemap packed" (colored_tilemap_packed) in category "terrain".
