# Visual Blueprint: medievalRTS spritesheet@2

- **Asset ID / Stem**: `medievalRTS_spritesheet@2`
- **Category**: `terrain`
- **Pack Slug**: `kenney-rts-medieval`
...
Synthesize a resolution-independent SVG vector graphic for "medievalRTS spritesheet@2" (medievalRTS_spritesheet@2) in category "terrain".
