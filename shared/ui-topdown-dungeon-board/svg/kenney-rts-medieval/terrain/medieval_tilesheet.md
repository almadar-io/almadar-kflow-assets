# Visual Blueprint: medieval tilesheet

- **Asset ID / Stem**: `medieval_tilesheet`
- **Category**: `terrain`
...
Synthesize a resolution-independent SVG vector graphic for "medieval tilesheet" (medieval_tilesheet) in category "terrain".
