# Visual Blueprint: medievalRTS spritesheet

- **Asset ID / Stem**: `medievalRTS_spritesheet`
- **Category**: `terrain`
...
Synthesize a resolution-independent SVG vector graphic for "medievalRTS spritesheet" (medievalRTS_spritesheet) in category "terrain".
