# Visual Blueprint: monochrome packed

- **Asset ID / Stem**: `monochrome_packed`
- **Category**: `terrain`
...
Synthesize a resolution-independent SVG vector graphic for "monochrome packed" (monochrome_packed) in category "terrain".
