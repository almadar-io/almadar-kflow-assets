# Visual Blueprint: colored-transparent packed

- **Asset ID / Stem**: `colored-transparent_packed`
- **Category**: `terrain`
...
Synthesize a resolution-independent SVG vector graphic for "colored-transparent packed" (colored-transparent_packed) in category "terrain".
