# Visual Blueprint: monochrome-transparent packed

- **Asset ID / Stem**: `monochrome-transparent_packed`
- **Category**: `terrain`
...
Synthesize a resolution-independent SVG vector graphic for "monochrome-transparent packed" (monochrome-transparent_packed) in category "terrain".
