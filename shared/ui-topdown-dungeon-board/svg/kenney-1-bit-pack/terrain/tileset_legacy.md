# Visual Blueprint: tileset legacy

- **Asset ID / Stem**: `tileset_legacy`
- **Category**: `terrain`
...
Synthesize a resolution-independent SVG vector graphic for "tileset legacy" (tileset_legacy) in category "terrain".
