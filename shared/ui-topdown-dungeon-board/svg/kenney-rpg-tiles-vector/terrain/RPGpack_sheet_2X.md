# Visual Blueprint: RPGpack sheet 2X

- **Asset ID / Stem**: `RPGpack_sheet_2X`
- **Category**: `terrain`
- **Pack Slug**: `kenney-rpg-tiles-vector`
...
Synthesize a resolution-independent SVG vector graphic for "RPGpack sheet 2X" (RPGpack_sheet_2X) in category "terrain".
