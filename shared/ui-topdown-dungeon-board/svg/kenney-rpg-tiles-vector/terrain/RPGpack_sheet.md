# Visual Blueprint: RPGpack sheet

- **Asset ID / Stem**: `RPGpack_sheet`
- **Category**: `terrain`
...
Synthesize a resolution-independent SVG vector graphic for "RPGpack sheet" (RPGpack_sheet) in category "terrain".
