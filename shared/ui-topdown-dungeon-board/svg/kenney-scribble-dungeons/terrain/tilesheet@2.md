# Visual Blueprint: tilesheet@2

- **Asset ID / Stem**: `tilesheet@2`
- **Category**: `terrain`
- **Pack Slug**: `kenney-scribble-dungeons`
...
Synthesize a resolution-independent SVG vector graphic for "tilesheet@2" (tilesheet@2) in category "terrain".
