# Visual Blueprint: isoMinigolf sheet

- **Asset ID / Stem**: `isoMinigolf_sheet`
- **Category**: `terrain`
- **Pack Slug**: `kenney-isometric-minigolf`
...
Synthesize a resolution-independent SVG vector graphic for "isoMinigolf sheet" (isoMinigolf_sheet) in category "terrain".
