...
board: ui-match-puzzle-board
projection: flat
role: npc
style: kenney-pixel-vector
states: { static: 1 }

Synthesize a resolution-independent SVG vector graphic for "gem yellow" (gem_yellow) in category "units".
...
Palette: primary #FDE047, secondary #EAB308, outline #1E293B.
