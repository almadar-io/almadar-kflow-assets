# Visual Blueprint: spritesheet aliens

- **Asset ID / Stem**: `spritesheet_aliens`
- **Category**: `units`
...
Synthesize a resolution-independent SVG vector graphic for "spritesheet aliens" (spritesheet_aliens) in category "units".
