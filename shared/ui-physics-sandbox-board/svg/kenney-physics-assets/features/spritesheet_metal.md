# Visual Blueprint: spritesheet metal

- **Asset ID / Stem**: `spritesheet_metal`
- **Category**: `features`
...
Synthesize a resolution-independent SVG vector graphic for "spritesheet metal" (spritesheet_metal) in category "features".
