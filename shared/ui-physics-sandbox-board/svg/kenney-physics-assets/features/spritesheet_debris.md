# Visual Blueprint: spritesheet debris

- **Asset ID / Stem**: `spritesheet_debris`
- **Category**: `features`
...
Synthesize a resolution-independent SVG vector graphic for "spritesheet debris" (spritesheet_debris) in category "features".
