# Visual Blueprint: spritesheet elements

- **Asset ID / Stem**: `spritesheet_elements`
- **Category**: `features`
...
Synthesize a resolution-independent SVG vector graphic for "spritesheet elements" (spritesheet_elements) in category "features".
