# Visual Blueprint: spritesheet glass

- **Asset ID / Stem**: `spritesheet_glass`
- **Category**: `features`
...
Synthesize a resolution-independent SVG vector graphic for "spritesheet glass" (spritesheet_glass) in category "features".
