# Visual Blueprint: spritesheet explosive

- **Asset ID / Stem**: `spritesheet_explosive`
- **Category**: `effects`
- **Pack Slug**: `kenney-physics-assets`
...
Synthesize a resolution-independent SVG vector graphic for "spritesheet explosive" (spritesheet_explosive) in category "effects".
