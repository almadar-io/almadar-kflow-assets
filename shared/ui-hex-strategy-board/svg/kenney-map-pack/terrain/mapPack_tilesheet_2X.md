# Visual Blueprint: mapPack tilesheet 2X

- **Asset ID / Stem**: `mapPack_tilesheet_2X`
- **Category**: `terrain`
- **Pack Slug**: `kenney-map-pack`
...
Hexagonal surface terrain representing mapPack tilesheet 2X with inner border contour lines and themed environmental landmarks.
...
Synthesize a resolution-independent SVG vector graphic for "mapPack tilesheet 2X" (mapPack_tilesheet_2X) in category "terrain".
...
Surface & Details: Hexagonal surface terrain representing mapPack tilesheet 2X with inner border contour lines and themed environmental landmarks.
