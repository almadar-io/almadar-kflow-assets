# Visual Blueprint: mapPack spritesheet

- **Asset ID / Stem**: `mapPack_spritesheet`
- **Category**: `terrain`
...
Hexagonal surface terrain representing mapPack spritesheet with inner border contour lines and themed environmental landmarks.
...
Synthesize a resolution-independent SVG vector graphic for "mapPack spritesheet" (mapPack_spritesheet) in category "terrain".
...
Surface & Details: Hexagonal surface terrain representing mapPack spritesheet with inner border contour lines and themed environmental landmarks.
