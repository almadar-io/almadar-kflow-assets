# Visual Blueprint: mapPack tilesheet

- **Asset ID / Stem**: `mapPack_tilesheet`
- **Category**: `terrain`
...
Hexagonal surface terrain representing mapPack tilesheet with inner border contour lines and themed environmental landmarks.
...
Synthesize a resolution-independent SVG vector graphic for "mapPack tilesheet" (mapPack_tilesheet) in category "terrain".
...
Surface & Details: Hexagonal surface terrain representing mapPack tilesheet with inner border contour lines and themed environmental landmarks.
