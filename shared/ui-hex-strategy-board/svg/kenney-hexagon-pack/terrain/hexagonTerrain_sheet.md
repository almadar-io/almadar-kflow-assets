# Visual Blueprint: hexagonTerrain sheet

- **Asset ID / Stem**: `hexagonTerrain_sheet`
- **Category**: `terrain`
...
Hexagonal surface terrain representing hexagonTerrain sheet with inner border contour lines and themed environmental landmarks.
...
Synthesize a resolution-independent SVG vector graphic for "hexagonTerrain sheet" (hexagonTerrain_sheet) in category "terrain".
...
Surface & Details: Hexagonal surface terrain representing hexagonTerrain sheet with inner border contour lines and themed environmental landmarks.
