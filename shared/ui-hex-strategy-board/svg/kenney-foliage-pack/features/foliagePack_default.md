# Visual Blueprint: foliagePack default

- **Asset ID / Stem**: `foliagePack_default`
- **Category**: `features`
...
Hexagonal surface terrain representing foliagePack default with inner border contour lines and themed environmental landmarks.
...
Synthesize a resolution-independent SVG vector graphic for "foliagePack default" (foliagePack_default) in category "features".
...
Surface & Details: Hexagonal surface terrain representing foliagePack default with inner border contour lines and themed environmental landmarks.
