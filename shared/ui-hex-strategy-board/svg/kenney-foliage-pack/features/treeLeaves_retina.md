# Visual Blueprint: treeLeaves retina

- **Asset ID / Stem**: `treeLeaves_retina`
- **Category**: `features`
...
Hexagonal surface terrain representing treeLeaves retina with inner border contour lines and themed environmental landmarks.
...
Synthesize a resolution-independent SVG vector graphic for "treeLeaves retina" (treeLeaves_retina) in category "features".
...
Surface & Details: Hexagonal surface terrain representing treeLeaves retina with inner border contour lines and themed environmental landmarks.
