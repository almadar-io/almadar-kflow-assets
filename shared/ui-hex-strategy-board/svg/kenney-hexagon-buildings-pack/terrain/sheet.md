# Visual Blueprint: sheet

- **Asset ID / Stem**: `sheet`
- **Category**: `terrain`
- **Pack Slug**: `kenney-hexagon-buildings-pack`
...
Hexagonal surface terrain representing sheet with inner border contour lines and themed environmental landmarks.
...
Synthesize a resolution-independent SVG vector graphic for "sheet" (sheet) in category "terrain".
...
Surface & Details: Hexagonal surface terrain representing sheet with inner border contour lines and themed environmental landmarks.
