# Visual Blueprint: spritesheet retina

- **Asset ID / Stem**: `spritesheet_retina`
- **Category**: `ui`
...
Hexagonal surface terrain representing spritesheet retina with inner border contour lines and themed environmental landmarks.
...
Synthesize a resolution-independent SVG vector graphic for "spritesheet retina" (spritesheet_retina) in category "ui".
...
Surface & Details: Hexagonal surface terrain representing spritesheet retina with inner border contour lines and themed environmental landmarks.
