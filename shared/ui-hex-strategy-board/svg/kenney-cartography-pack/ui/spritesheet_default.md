# Visual Blueprint: spritesheet default

- **Asset ID / Stem**: `spritesheet_default`
- **Category**: `ui`
- **Pack Slug**: `kenney-cartography-pack`
...
Hexagonal surface terrain representing spritesheet default with inner border contour lines and themed environmental landmarks.
...
Synthesize a resolution-independent SVG vector graphic for "spritesheet default" (spritesheet_default) in category "ui".
...
Surface & Details: Hexagonal surface terrain representing spritesheet default with inner border contour lines and themed environmental landmarks.
