# Visual Blueprint: spritesheet-double

- **Asset ID / Stem**: `spritesheet-double`
- **Category**: `terrain`
- **Pack Slug**: `kenney-fish-pack`
...
Hexagonal surface terrain representing spritesheet-double with inner border contour lines and themed environmental landmarks.
...
Synthesize a resolution-independent SVG vector graphic for "spritesheet-double" (spritesheet-double) in category "terrain".
...
Surface & Details: Hexagonal surface terrain representing spritesheet-double with inner border contour lines and themed environmental landmarks.
