# Visual Blueprint: spritesheet

- **Asset ID / Stem**: `spritesheet`
- **Category**: `terrain`
...
Hexagonal surface terrain representing spritesheet with inner border contour lines and themed environmental landmarks.
...
Synthesize a resolution-independent SVG vector graphic for "spritesheet" (spritesheet) in category "terrain".
...
Surface & Details: Hexagonal surface terrain representing spritesheet with inner border contour lines and themed environmental landmarks.
