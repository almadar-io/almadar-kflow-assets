# Visual Blueprint: tilemap packed

- **Asset ID / Stem**: `tilemap_packed`
- **Category**: `terrain`
- **Pack Slug**: `kenney-rts-medieval-pixel`
...
Hexagonal surface terrain representing tilemap packed with inner border contour lines and themed environmental landmarks.
...
Synthesize a resolution-independent SVG vector graphic for "tilemap packed" (tilemap_packed) in category "terrain".
...
Surface & Details: Hexagonal surface terrain representing tilemap packed with inner border contour lines and themed environmental landmarks.
