# Visual Blueprint: topTiles

- **Asset ID / Stem**: `topTiles`
- **Category**: `terrain`
...
Hexagonal surface terrain representing topTiles with inner border contour lines and themed environmental landmarks.
...
Synthesize a resolution-independent SVG vector graphic for "topTiles" (topTiles) in category "terrain".
...
Surface & Details: Hexagonal surface terrain representing topTiles with inner border contour lines and themed environmental landmarks.
