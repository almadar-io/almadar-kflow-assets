# Visual Blueprint: details

- **Asset ID / Stem**: `details`
- **Category**: `terrain`
...
Hexagonal surface terrain representing details with inner border contour lines and themed environmental landmarks.
...
Synthesize a resolution-independent SVG vector graphic for "details" (details) in category "terrain".
...
Surface & Details: Hexagonal surface terrain representing details with inner border contour lines and themed environmental landmarks.
