# Visual Blueprint: fullTiles

- **Asset ID / Stem**: `fullTiles`
- **Category**: `terrain`
- **Pack Slug**: `kenney-hexagon-base-pack`
...
Hexagonal surface terrain representing fullTiles with inner border contour lines and themed environmental landmarks.
...
Synthesize a resolution-independent SVG vector graphic for "fullTiles" (fullTiles) in category "terrain".
...
Surface & Details: Hexagonal surface terrain representing fullTiles with inner border contour lines and themed environmental landmarks.
