...
Hexagonal surface terrain representing trees with inner border contour lines and themed environmental landmarks.
...
Synthesize a resolution-independent SVG vector graphic for "trees" (trees) in category "features".
...
Surface & Details: Hexagonal surface terrain representing trees with inner border contour lines and themed environmental landmarks.
