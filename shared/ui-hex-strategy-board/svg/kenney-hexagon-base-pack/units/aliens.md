# Visual Blueprint: aliens

- **Asset ID / Stem**: `aliens`
- **Category**: `units`
...
Hexagonal surface terrain representing aliens with inner border contour lines and themed environmental landmarks.
...
Synthesize a resolution-independent SVG vector graphic for "aliens" (aliens) in category "units".
...
Surface & Details: Hexagonal surface terrain representing aliens with inner border contour lines and themed environmental landmarks.
