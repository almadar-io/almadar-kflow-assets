...
Synthesize a resolution-independent SVG vector graphic for "archer" (archer) in category "units".
...
Surface & Details: Hexagonal surface terrain representing archer with inner border contour lines and themed environmental landmarks.
