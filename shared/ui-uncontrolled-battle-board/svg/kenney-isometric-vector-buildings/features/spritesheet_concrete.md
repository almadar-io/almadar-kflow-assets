# Visual Blueprint: spritesheet concrete

- **Asset ID / Stem**: `spritesheet_concrete`
- **Category**: `features`
...
Synthesize a resolution-independent SVG vector graphic for "spritesheet concrete" (spritesheet_concrete) in category "features".
