# Visual Blueprint: spritesheet wood

- **Asset ID / Stem**: `spritesheet_wood`
- **Category**: `features`
...
Synthesize a resolution-independent SVG vector graphic for "spritesheet wood" (spritesheet_wood) in category "features".
