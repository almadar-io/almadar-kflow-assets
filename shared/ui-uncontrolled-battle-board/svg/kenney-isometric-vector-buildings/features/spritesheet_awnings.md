# Visual Blueprint: spritesheet awnings

- **Asset ID / Stem**: `spritesheet_awnings`
- **Category**: `features`
...
Synthesize a resolution-independent SVG vector graphic for "spritesheet awnings" (spritesheet_awnings) in category "features".
