# Visual Blueprint: voxelTiles sheet

- **Asset ID / Stem**: `voxelTiles_sheet`
- **Category**: `terrain`
...
Synthesize a resolution-independent SVG vector graphic for "voxelTiles sheet" (voxelTiles_sheet) in category "terrain".
