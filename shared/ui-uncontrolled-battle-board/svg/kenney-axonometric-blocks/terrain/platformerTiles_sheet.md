# Visual Blueprint: platformerTiles sheet

- **Asset ID / Stem**: `platformerTiles_sheet`
- **Category**: `terrain`
- **Pack Slug**: `kenney-axonometric-blocks`
- **Board Genre**: `ui-uncontrolled-battle-board`
...
Synthesize a resolution-independent SVG vector graphic for "platformerTiles sheet" (platformerTiles_sheet) in category "terrain".
