# Visual Blueprint: abstractTiles sheet

- **Asset ID / Stem**: `abstractTiles_sheet`
- **Category**: `terrain`
...
Synthesize a resolution-independent SVG vector graphic for "abstractTiles sheet" (abstractTiles_sheet) in category "terrain".
