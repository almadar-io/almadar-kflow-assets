# Visual Blueprint: allTiles sheet

- **Asset ID / Stem**: `allTiles_sheet`
- **Category**: `terrain`
...
Synthesize a resolution-independent SVG vector graphic for "allTiles sheet" (allTiles_sheet) in category "terrain".
