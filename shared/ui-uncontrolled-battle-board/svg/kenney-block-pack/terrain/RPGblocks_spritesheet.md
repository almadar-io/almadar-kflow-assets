# Visual Blueprint: RPGblocks spritesheet

- **Asset ID / Stem**: `RPGblocks_spritesheet`
- **Category**: `terrain`
...
Synthesize a resolution-independent SVG vector graphic for "RPGblocks spritesheet" (RPGblocks_spritesheet) in category "terrain".
