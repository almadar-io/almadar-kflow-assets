# Visual Blueprint: RPGblocks tilesheet

- **Asset ID / Stem**: `RPGblocks_tilesheet`
- **Category**: `terrain`
...
Synthesize a resolution-independent SVG vector graphic for "RPGblocks tilesheet" (RPGblocks_tilesheet) in category "terrain".
