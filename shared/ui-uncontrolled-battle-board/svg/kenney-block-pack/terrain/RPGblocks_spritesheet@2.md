# Visual Blueprint: RPGblocks spritesheet@2

- **Asset ID / Stem**: `RPGblocks_spritesheet@2`
- **Category**: `terrain`
- **Pack Slug**: `kenney-block-pack`
...
Synthesize a resolution-independent SVG vector graphic for "RPGblocks spritesheet@2" (RPGblocks_spritesheet@2) in category "terrain".
