# Visual Blueprint: buildingTiles sheet

- **Asset ID / Stem**: `buildingTiles_sheet`
- **Category**: `terrain`
- **Pack Slug**: `kenney-isometric-tiles-buildings`
...
Synthesize a resolution-independent SVG vector graphic for "buildingTiles sheet" (buildingTiles_sheet) in category "terrain".
