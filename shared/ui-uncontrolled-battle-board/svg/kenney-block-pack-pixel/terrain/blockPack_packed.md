# Visual Blueprint: blockPack packed

- **Asset ID / Stem**: `blockPack_packed`
- **Category**: `terrain`
- **Pack Slug**: `kenney-block-pack-pixel`
...
Synthesize a resolution-independent SVG vector graphic for "blockPack packed" (blockPack_packed) in category "terrain".
