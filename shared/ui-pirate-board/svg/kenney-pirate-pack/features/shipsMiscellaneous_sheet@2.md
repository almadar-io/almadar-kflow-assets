# Visual Blueprint: shipsMiscellaneous sheet@2

- **Asset ID / Stem**: `shipsMiscellaneous_sheet@2`
- **Category**: `features`
- **Pack Slug**: `kenney-pirate-pack`
- **Board Genre**: `ui-pirate-board`
...
Synthesize a resolution-independent SVG vector graphic for "shipsMiscellaneous sheet@2" (shipsMiscellaneous_sheet@2) in category "features".
