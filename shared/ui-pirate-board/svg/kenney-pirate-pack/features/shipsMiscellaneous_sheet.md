# Visual Blueprint: shipsMiscellaneous sheet

- **Asset ID / Stem**: `shipsMiscellaneous_sheet`
- **Category**: `features`
...
Synthesize a resolution-independent SVG vector graphic for "shipsMiscellaneous sheet" (shipsMiscellaneous_sheet) in category "features".
