# Visual Blueprint: tiles sheet@2

- **Asset ID / Stem**: `tiles_sheet@2`
- **Category**: `terrain`
...
Synthesize a resolution-independent SVG vector graphic for "tiles sheet@2" (tiles_sheet@2) in category "terrain".
