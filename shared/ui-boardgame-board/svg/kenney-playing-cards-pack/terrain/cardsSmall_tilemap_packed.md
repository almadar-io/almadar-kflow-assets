# Visual Blueprint: cardsSmall tilemap packed

- **Asset ID / Stem**: `cardsSmall_tilemap_packed`
- **Category**: `terrain`
...
Card rank "CAR" displayed in top-left and bottom-right corners with large central suit emblem symbol for cardsSmall tilemap packed.
...
Synthesize a resolution-independent SVG vector graphic for "cardsSmall tilemap packed" (cardsSmall_tilemap_packed) in category "terrain".
...
Surface & Details: Card rank "CAR" displayed in top-left and bottom-right corners with large central suit emblem symbol for cardsSmall tilemap packed.
