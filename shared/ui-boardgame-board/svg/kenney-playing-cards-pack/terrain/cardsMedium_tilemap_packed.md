# Visual Blueprint: cardsMedium tilemap packed

- **Asset ID / Stem**: `cardsMedium_tilemap_packed`
- **Category**: `terrain`
...
Card rank "CAR" displayed in top-left and bottom-right corners with large central suit emblem symbol for cardsMedium tilemap packed.
...
Synthesize a resolution-independent SVG vector graphic for "cardsMedium tilemap packed" (cardsMedium_tilemap_packed) in category "terrain".
...
Surface & Details: Card rank "CAR" displayed in top-left and bottom-right corners with large central suit emblem symbol for cardsMedium tilemap packed.
