# Visual Blueprint: platformerPack character

- **Asset ID / Stem**: `platformerPack_character`
- **Category**: `terrain`
...
Synthesize a resolution-independent SVG vector graphic for "platformerPack character" (platformerPack_character) in category "terrain".
