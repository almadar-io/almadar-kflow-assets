# Visual Blueprint: platformerPack character@2

- **Asset ID / Stem**: `platformerPack_character@2`
- **Category**: `terrain`
- **Pack Slug**: `kenney-simplified-platformer-pack`
...
Synthesize a resolution-independent SVG vector graphic for "platformerPack character@2" (platformerPack_character@2) in category "terrain".
