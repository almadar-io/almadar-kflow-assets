# Visual Blueprint: platformPack tilesheet@2

- **Asset ID / Stem**: `platformPack_tilesheet@2`
- **Category**: `terrain`
...
Synthesize a resolution-independent SVG vector graphic for "platformPack tilesheet@2" (platformPack_tilesheet@2) in category "terrain".
