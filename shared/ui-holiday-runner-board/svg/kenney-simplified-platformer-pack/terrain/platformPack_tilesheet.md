# Visual Blueprint: platformPack tilesheet

- **Asset ID / Stem**: `platformPack_tilesheet`
- **Category**: `terrain`
...
Synthesize a resolution-independent SVG vector graphic for "platformPack tilesheet" (platformPack_tilesheet) in category "terrain".
