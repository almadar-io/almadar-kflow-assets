# Visual Blueprint: spritesheet other

- **Asset ID / Stem**: `spritesheet_other`
- **Category**: `terrain`
...
Synthesize a resolution-independent SVG vector graphic for "spritesheet other" (spritesheet_other) in category "terrain".
