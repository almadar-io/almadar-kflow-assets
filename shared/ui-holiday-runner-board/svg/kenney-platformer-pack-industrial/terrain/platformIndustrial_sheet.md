# Visual Blueprint: platformIndustrial sheet

- **Asset ID / Stem**: `platformIndustrial_sheet`
- **Category**: `terrain`
...
Synthesize a resolution-independent SVG vector graphic for "platformIndustrial sheet" (platformIndustrial_sheet) in category "terrain".
