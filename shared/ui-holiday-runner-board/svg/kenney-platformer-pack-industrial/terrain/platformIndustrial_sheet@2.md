# Visual Blueprint: platformIndustrial sheet@2

- **Asset ID / Stem**: `platformIndustrial_sheet@2`
- **Category**: `terrain`
...
Synthesize a resolution-independent SVG vector graphic for "platformIndustrial sheet@2" (platformIndustrial_sheet@2) in category "terrain".
