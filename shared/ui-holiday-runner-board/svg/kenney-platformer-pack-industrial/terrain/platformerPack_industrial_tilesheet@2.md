# Visual Blueprint: platformerPack industrial tilesheet@2

- **Asset ID / Stem**: `platformerPack_industrial_tilesheet@2`
- **Category**: `terrain`
- **Pack Slug**: `kenney-platformer-pack-industrial`
...
Synthesize a resolution-independent SVG vector graphic for "platformerPack industrial tilesheet@2" (platformerPack_industrial_tilesheet@2) in category "terrain".
