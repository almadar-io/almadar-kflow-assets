# Visual Blueprint: platformerPack industrial tilesheet

- **Asset ID / Stem**: `platformerPack_industrial_tilesheet`
- **Category**: `terrain`
...
Synthesize a resolution-independent SVG vector graphic for "platformerPack industrial tilesheet" (platformerPack_industrial_tilesheet) in category "terrain".
