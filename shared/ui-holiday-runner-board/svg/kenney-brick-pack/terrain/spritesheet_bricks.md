# Visual Blueprint: spritesheet bricks

- **Asset ID / Stem**: `spritesheet_bricks`
- **Category**: `terrain`
- **Pack Slug**: `kenney-brick-pack`
...
Synthesize a resolution-independent SVG vector graphic for "spritesheet bricks" (spritesheet_bricks) in category "terrain".
