# Visual Blueprint: tilemap-characters packed

- **Asset ID / Stem**: `tilemap-characters_packed`
- **Category**: `terrain`
...
Synthesize a resolution-independent SVG vector graphic for "tilemap-characters packed" (tilemap-characters_packed) in category "terrain".
