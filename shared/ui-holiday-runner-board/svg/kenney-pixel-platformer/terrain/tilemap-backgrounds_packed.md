# Visual Blueprint: tilemap-backgrounds packed

- **Asset ID / Stem**: `tilemap-backgrounds_packed`
- **Category**: `terrain`
- **Pack Slug**: `kenney-pixel-platformer`
...
Synthesize a resolution-independent SVG vector graphic for "tilemap-backgrounds packed" (tilemap-backgrounds_packed) in category "terrain".
