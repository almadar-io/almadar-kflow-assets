# Visual Blueprint: planes

- **Asset ID / Stem**: `planes`
- **Category**: `features`
- **Pack Slug**: `kenney-tappy-plane`
...
Synthesize a resolution-independent SVG vector graphic for "planes" (planes) in category "features".
