...
- **Category**: `terrain`
- **Pack Slug**: `kenney-scribble-platformer`
...
Synthesize a resolution-independent SVG vector graphic for "spritesheet default" (spritesheet_default) in category "terrain".
