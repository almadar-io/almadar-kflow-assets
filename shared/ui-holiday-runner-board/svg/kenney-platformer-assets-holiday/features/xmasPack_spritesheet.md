# Visual Blueprint: xmasPack spritesheet

- **Asset ID / Stem**: `xmasPack_spritesheet`
- **Category**: `features`
- **Pack Slug**: `kenney-platformer-assets-holiday`
...
Synthesize a resolution-independent SVG vector graphic for "xmasPack spritesheet" (xmasPack_spritesheet) in category "features".
