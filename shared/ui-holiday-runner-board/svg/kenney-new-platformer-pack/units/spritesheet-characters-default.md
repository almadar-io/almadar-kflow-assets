# Visual Blueprint: spritesheet-characters-default

- **Asset ID / Stem**: `spritesheet-characters-default`
- **Category**: `units`
...
Synthesize a resolution-independent SVG vector graphic for "spritesheet-characters-default" (spritesheet-characters-default) in category "units".
