# Visual Blueprint: spritesheet-enemies-default

- **Asset ID / Stem**: `spritesheet-enemies-default`
- **Category**: `units`
...
Synthesize a resolution-independent SVG vector graphic for "spritesheet-enemies-default" (spritesheet-enemies-default) in category "units".
