# Visual Blueprint: spritesheet-characters-double

- **Asset ID / Stem**: `spritesheet-characters-double`
- **Category**: `units`
...
Synthesize a resolution-independent SVG vector graphic for "spritesheet-characters-double" (spritesheet-characters-double) in category "units".
