# Visual Blueprint: spritesheet-enemies-double

- **Asset ID / Stem**: `spritesheet-enemies-double`
- **Category**: `units`
...
Synthesize a resolution-independent SVG vector graphic for "spritesheet-enemies-double" (spritesheet-enemies-double) in category "units".
