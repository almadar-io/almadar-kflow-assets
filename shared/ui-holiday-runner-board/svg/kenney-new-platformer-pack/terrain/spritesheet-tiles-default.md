# Visual Blueprint: spritesheet-tiles-default

- **Asset ID / Stem**: `spritesheet-tiles-default`
- **Category**: `terrain`
...
Synthesize a resolution-independent SVG vector graphic for "spritesheet-tiles-default" (spritesheet-tiles-default) in category "terrain".
