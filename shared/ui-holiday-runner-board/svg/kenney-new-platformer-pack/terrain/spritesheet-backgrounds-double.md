# Visual Blueprint: spritesheet-backgrounds-double

- **Asset ID / Stem**: `spritesheet-backgrounds-double`
- **Category**: `terrain`
...
Synthesize a resolution-independent SVG vector graphic for "spritesheet-backgrounds-double" (spritesheet-backgrounds-double) in category "terrain".
