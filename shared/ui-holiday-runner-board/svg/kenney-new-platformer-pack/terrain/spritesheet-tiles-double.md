# Visual Blueprint: spritesheet-tiles-double

- **Asset ID / Stem**: `spritesheet-tiles-double`
- **Category**: `terrain`
...
Synthesize a resolution-independent SVG vector graphic for "spritesheet-tiles-double" (spritesheet-tiles-double) in category "terrain".
