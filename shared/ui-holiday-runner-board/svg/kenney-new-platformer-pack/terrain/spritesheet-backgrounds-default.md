# Visual Blueprint: spritesheet-backgrounds-default

- **Asset ID / Stem**: `spritesheet-backgrounds-default`
- **Category**: `terrain`
- **Pack Slug**: `kenney-new-platformer-pack`
...
Synthesize a resolution-independent SVG vector graphic for "spritesheet-backgrounds-default" (spritesheet-backgrounds-default) in category "terrain".
