# Visual Blueprint: monochrome tilemap transparent packed

- **Asset ID / Stem**: `monochrome_tilemap_transparent_packed`
- **Category**: `terrain`
- **Pack Slug**: `kenney-1-bit-platformer-pack`
...
Synthesize a resolution-independent SVG vector graphic for "monochrome tilemap transparent packed" (monochrome_tilemap_transparent_packed) in category "terrain".
