# Visual Blueprint: monochrome tilemap packed

- **Asset ID / Stem**: `monochrome_tilemap_packed`
- **Category**: `terrain`
...
Synthesize a resolution-independent SVG vector graphic for "monochrome tilemap packed" (monochrome_tilemap_packed) in category "terrain".
