# Visual Blueprint: spritesheet players

- **Asset ID / Stem**: `spritesheet_players`
- **Category**: `units`
- **Pack Slug**: `kenney-platformer-pack-redux`
...
Synthesize a resolution-independent SVG vector graphic for "spritesheet players" (spritesheet_players) in category "units".
