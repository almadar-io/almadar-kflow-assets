# Visual Blueprint: spritesheet enemies

- **Asset ID / Stem**: `spritesheet_enemies`
- **Category**: `units`
...
Synthesize a resolution-independent SVG vector graphic for "spritesheet enemies" (spritesheet_enemies) in category "units".
