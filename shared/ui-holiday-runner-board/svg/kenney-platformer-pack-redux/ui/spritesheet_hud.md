# Visual Blueprint: spritesheet hud

- **Asset ID / Stem**: `spritesheet_hud`
- **Category**: `ui`
...
Synthesize a resolution-independent SVG vector graphic for "spritesheet hud" (spritesheet_hud) in category "ui".
