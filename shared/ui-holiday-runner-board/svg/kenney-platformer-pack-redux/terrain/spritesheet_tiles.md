# Visual Blueprint: spritesheet tiles

- **Asset ID / Stem**: `spritesheet_tiles`
- **Category**: `terrain`
...
Synthesize a resolution-independent SVG vector graphic for "spritesheet tiles" (spritesheet_tiles) in category "terrain".
