# Visual Blueprint: spritesheet ground

- **Asset ID / Stem**: `spritesheet_ground`
- **Category**: `terrain`
...
Synthesize a resolution-independent SVG vector graphic for "spritesheet ground" (spritesheet_ground) in category "terrain".
