# Visual Blueprint: spritesheet items

- **Asset ID / Stem**: `spritesheet_items`
- **Category**: `features`
...
Synthesize a resolution-independent SVG vector graphic for "spritesheet items" (spritesheet_items) in category "features".
