# Visual Blueprint: voxelPack tilesheet

- **Asset ID / Stem**: `voxelPack_tilesheet`
- **Category**: `terrain`
...
Synthesize a resolution-independent SVG vector graphic for "voxelPack tilesheet" (voxelPack_tilesheet) in category "terrain".
