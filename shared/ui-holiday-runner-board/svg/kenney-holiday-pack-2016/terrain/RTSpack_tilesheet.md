# Visual Blueprint: RTSpack tilesheet

- **Asset ID / Stem**: `RTSpack_tilesheet`
- **Category**: `terrain`
...
Synthesize a resolution-independent SVG vector graphic for "RTSpack tilesheet" (RTSpack_tilesheet) in category "terrain".
