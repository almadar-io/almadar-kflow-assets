# Visual Blueprint: topdownPack tilesheet

- **Asset ID / Stem**: `topdownPack_tilesheet`
- **Category**: `terrain`
...
Synthesize a resolution-independent SVG vector graphic for "topdownPack tilesheet" (topdownPack_tilesheet) in category "terrain".
