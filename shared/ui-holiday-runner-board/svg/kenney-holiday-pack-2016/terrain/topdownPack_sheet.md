# Visual Blueprint: topdownPack sheet

- **Asset ID / Stem**: `topdownPack_sheet`
- **Category**: `terrain`
...
Synthesize a resolution-independent SVG vector graphic for "topdownPack sheet" (topdownPack_sheet) in category "terrain".
