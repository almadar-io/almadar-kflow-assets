# Visual Blueprint: roguelikeHoliday transparent

- **Asset ID / Stem**: `roguelikeHoliday_transparent`
- **Category**: `terrain`
- **Pack Slug**: `kenney-holiday-pack-2016`
...
Synthesize a resolution-independent SVG vector graphic for "roguelikeHoliday transparent" (roguelikeHoliday_transparent) in category "terrain".
