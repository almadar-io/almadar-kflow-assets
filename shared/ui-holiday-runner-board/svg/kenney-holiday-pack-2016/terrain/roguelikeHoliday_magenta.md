# Visual Blueprint: roguelikeHoliday magenta

- **Asset ID / Stem**: `roguelikeHoliday_magenta`
- **Category**: `terrain`
...
Synthesize a resolution-independent SVG vector graphic for "roguelikeHoliday magenta" (roguelikeHoliday_magenta) in category "terrain".
