# Visual Blueprint: topdownPack tilesheet@2

- **Asset ID / Stem**: `topdownPack_tilesheet@2`
- **Category**: `terrain`
...
Synthesize a resolution-independent SVG vector graphic for "topdownPack tilesheet@2" (topdownPack_tilesheet@2) in category "terrain".
