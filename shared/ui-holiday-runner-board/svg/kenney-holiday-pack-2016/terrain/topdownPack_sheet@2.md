# Visual Blueprint: topdownPack sheet@2

- **Asset ID / Stem**: `topdownPack_sheet@2`
- **Category**: `terrain`
...
Synthesize a resolution-independent SVG vector graphic for "topdownPack sheet@2" (topdownPack_sheet@2) in category "terrain".
