# Visual Blueprint: foliagePack sheet

- **Asset ID / Stem**: `foliagePack_sheet`
- **Category**: `features`
...
Synthesize a resolution-independent SVG vector graphic for "foliagePack sheet" (foliagePack_sheet) in category "features".
