# Visual Blueprint: foliagePack sheet@2

- **Asset ID / Stem**: `foliagePack_sheet@2`
- **Category**: `features`
...
Synthesize a resolution-independent SVG vector graphic for "foliagePack sheet@2" (foliagePack_sheet@2) in category "features".
