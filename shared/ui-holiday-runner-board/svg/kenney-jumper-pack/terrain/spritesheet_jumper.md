# Visual Blueprint: spritesheet jumper

- **Asset ID / Stem**: `spritesheet_jumper`
- **Category**: `terrain`
- **Pack Slug**: `kenney-jumper-pack`
...
Synthesize a resolution-independent SVG vector graphic for "spritesheet jumper" (spritesheet_jumper) in category "terrain".
