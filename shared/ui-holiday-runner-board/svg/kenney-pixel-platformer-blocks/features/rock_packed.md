# Visual Blueprint: rock packed

- **Asset ID / Stem**: `rock_packed`
- **Category**: `features`
...
Synthesize a resolution-independent SVG vector graphic for "rock packed" (rock_packed) in category "features".
