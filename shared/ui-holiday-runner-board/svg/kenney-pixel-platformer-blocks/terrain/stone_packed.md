# Visual Blueprint: stone packed

- **Asset ID / Stem**: `stone_packed`
- **Category**: `terrain`
...
Synthesize a resolution-independent SVG vector graphic for "stone packed" (stone_packed) in category "terrain".
