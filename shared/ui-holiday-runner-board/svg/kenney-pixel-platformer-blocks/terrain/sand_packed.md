# Visual Blueprint: sand packed

- **Asset ID / Stem**: `sand_packed`
- **Category**: `terrain`
...
Synthesize a resolution-independent SVG vector graphic for "sand packed" (sand_packed) in category "terrain".
