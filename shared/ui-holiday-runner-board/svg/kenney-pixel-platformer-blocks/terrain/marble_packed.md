# Visual Blueprint: marble packed

- **Asset ID / Stem**: `marble_packed`
- **Category**: `terrain`
- **Pack Slug**: `kenney-pixel-platformer-blocks`
...
Synthesize a resolution-independent SVG vector graphic for "marble packed" (marble_packed) in category "terrain".
