# Visual Blueprint: alienYellow

- **Asset ID / Stem**: `alienYellow`
- **Category**: `units`
- **Pack Slug**: `kenney-platformer-assets-extra-animations-enemies`
...
Synthesize a resolution-independent SVG vector graphic for "alienYellow" (alienYellow) in category "units".
