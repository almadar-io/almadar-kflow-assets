# Visual Blueprint: enemies sheet

- **Asset ID / Stem**: `enemies_sheet`
- **Category**: `units`
- **Pack Slug**: `kenney-platformer-assets-base`
...
Synthesize a resolution-independent SVG vector graphic for "enemies sheet" (enemies_sheet) in category "units".
