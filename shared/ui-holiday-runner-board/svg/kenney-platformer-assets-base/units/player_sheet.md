# Visual Blueprint: player sheet

- **Asset ID / Stem**: `player_sheet`
- **Category**: `units`
...
Synthesize a resolution-independent SVG vector graphic for "player sheet" (player_sheet) in category "units".
