# Visual Blueprint: items sheet

- **Asset ID / Stem**: `items_sheet`
- **Category**: `features`
...
Synthesize a resolution-independent SVG vector graphic for "items sheet" (items_sheet) in category "features".
