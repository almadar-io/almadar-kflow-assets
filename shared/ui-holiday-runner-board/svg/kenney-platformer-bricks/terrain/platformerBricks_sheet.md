# Visual Blueprint: platformerBricks sheet

- **Asset ID / Stem**: `platformerBricks_sheet`
- **Category**: `terrain`
- **Pack Slug**: `kenney-platformer-bricks`
...
Synthesize a resolution-independent SVG vector graphic for "platformerBricks sheet" (platformerBricks_sheet) in category "terrain".
