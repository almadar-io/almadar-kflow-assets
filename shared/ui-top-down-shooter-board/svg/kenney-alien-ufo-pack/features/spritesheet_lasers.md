# Visual Blueprint: spritesheet lasers

- **Asset ID / Stem**: `spritesheet_lasers`
- **Category**: `features`
...
Synthesize a resolution-independent SVG vector graphic for "spritesheet lasers" (spritesheet_lasers) in category "features".
