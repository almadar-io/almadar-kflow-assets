# Visual Blueprint: spritesheet spaceships

- **Asset ID / Stem**: `spritesheet_spaceships`
- **Category**: `features`
- **Pack Slug**: `kenney-alien-ufo-pack`
...
Synthesize a resolution-independent SVG vector graphic for "spritesheet spaceships" (spritesheet_spaceships) in category "features".
