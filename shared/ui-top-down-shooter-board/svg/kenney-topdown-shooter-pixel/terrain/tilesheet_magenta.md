# Visual Blueprint: tilesheet magenta

- **Asset ID / Stem**: `tilesheet_magenta`
- **Category**: `terrain`
...
Synthesize a resolution-independent SVG vector graphic for "tilesheet magenta" (tilesheet_magenta) in category "terrain".
