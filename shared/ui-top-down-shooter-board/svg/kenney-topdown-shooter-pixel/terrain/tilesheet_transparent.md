# Visual Blueprint: tilesheet transparent

- **Asset ID / Stem**: `tilesheet_transparent`
- **Category**: `terrain`
- **Pack Slug**: `kenney-topdown-shooter-pixel`
...
Synthesize a resolution-independent SVG vector graphic for "tilesheet transparent" (tilesheet_transparent) in category "terrain".
