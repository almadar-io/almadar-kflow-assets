# Visual Blueprint: roadTextures tilesheet

- **Asset ID / Stem**: `roadTextures_tilesheet`
- **Category**: `terrain`
...
Synthesize a resolution-independent SVG vector graphic for "roadTextures tilesheet" (roadTextures_tilesheet) in category "terrain".
