# Visual Blueprint: roadTextures tilesheet@2

- **Asset ID / Stem**: `roadTextures_tilesheet@2`
- **Category**: `terrain`
- **Pack Slug**: `kenney-road-textures`
...
Synthesize a resolution-independent SVG vector graphic for "roadTextures tilesheet@2" (roadTextures_tilesheet@2) in category "terrain".
