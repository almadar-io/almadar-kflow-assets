# Visual Blueprint: character robot sheetHD

- **Asset ID / Stem**: `character_robot_sheetHD`
- **Category**: `units`
...
Synthesize a resolution-independent SVG vector graphic for "character robot sheetHD" (character_robot_sheetHD) in category "units".
