# Visual Blueprint: character maleAdventurer sheetHD

- **Asset ID / Stem**: `character_maleAdventurer_sheetHD`
- **Category**: `units`
...
Synthesize a resolution-independent SVG vector graphic for "character maleAdventurer sheetHD" (character_maleAdventurer_sheetHD) in category "units".
