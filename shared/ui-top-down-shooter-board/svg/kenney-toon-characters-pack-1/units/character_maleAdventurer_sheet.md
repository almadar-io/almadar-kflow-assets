# Visual Blueprint: character maleAdventurer sheet

- **Asset ID / Stem**: `character_maleAdventurer_sheet`
- **Category**: `units`
...
Synthesize a resolution-independent SVG vector graphic for "character maleAdventurer sheet" (character_maleAdventurer_sheet) in category "units".
