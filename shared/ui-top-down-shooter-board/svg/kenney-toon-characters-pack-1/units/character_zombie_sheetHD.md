# Visual Blueprint: character zombie sheetHD

- **Asset ID / Stem**: `character_zombie_sheetHD`
- **Category**: `units`
...
Synthesize a resolution-independent SVG vector graphic for "character zombie sheetHD" (character_zombie_sheetHD) in category "units".
