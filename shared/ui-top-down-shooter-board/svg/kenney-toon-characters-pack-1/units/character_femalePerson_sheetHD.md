# Visual Blueprint: character femalePerson sheetHD

- **Asset ID / Stem**: `character_femalePerson_sheetHD`
- **Category**: `units`
...
Synthesize a resolution-independent SVG vector graphic for "character femalePerson sheetHD" (character_femalePerson_sheetHD) in category "units".
