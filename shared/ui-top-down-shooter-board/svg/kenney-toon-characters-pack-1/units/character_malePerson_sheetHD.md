# Visual Blueprint: character malePerson sheetHD

- **Asset ID / Stem**: `character_malePerson_sheetHD`
- **Category**: `units`
...
Synthesize a resolution-independent SVG vector graphic for "character malePerson sheetHD" (character_malePerson_sheetHD) in category "units".
