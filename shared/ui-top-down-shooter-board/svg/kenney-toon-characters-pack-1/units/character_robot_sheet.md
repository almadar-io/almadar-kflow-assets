# Visual Blueprint: character robot sheet

- **Asset ID / Stem**: `character_robot_sheet`
- **Category**: `units`
...
Synthesize a resolution-independent SVG vector graphic for "character robot sheet" (character_robot_sheet) in category "units".
