# Visual Blueprint: character zombie sheet

- **Asset ID / Stem**: `character_zombie_sheet`
- **Category**: `units`
...
Synthesize a resolution-independent SVG vector graphic for "character zombie sheet" (character_zombie_sheet) in category "units".
