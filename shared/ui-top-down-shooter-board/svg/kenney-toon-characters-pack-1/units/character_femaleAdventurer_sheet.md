# Visual Blueprint: character femaleAdventurer sheet

- **Asset ID / Stem**: `character_femaleAdventurer_sheet`
- **Category**: `units`
...
Synthesize a resolution-independent SVG vector graphic for "character femaleAdventurer sheet" (character_femaleAdventurer_sheet) in category "units".
