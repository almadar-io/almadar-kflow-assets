# Visual Blueprint: character femaleAdventurer sheetHD

- **Asset ID / Stem**: `character_femaleAdventurer_sheetHD`
- **Category**: `units`
- **Pack Slug**: `kenney-toon-characters-pack-1`
- **Board Genre**: `ui-top-down-shooter-board`
...
Synthesize a resolution-independent SVG vector graphic for "character femaleAdventurer sheetHD" (character_femaleAdventurer_sheetHD) in category "units".
