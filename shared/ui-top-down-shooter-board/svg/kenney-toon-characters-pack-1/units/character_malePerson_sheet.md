# Visual Blueprint: character malePerson sheet

- **Asset ID / Stem**: `character_malePerson_sheet`
- **Category**: `units`
...
Synthesize a resolution-independent SVG vector graphic for "character malePerson sheet" (character_malePerson_sheet) in category "units".
