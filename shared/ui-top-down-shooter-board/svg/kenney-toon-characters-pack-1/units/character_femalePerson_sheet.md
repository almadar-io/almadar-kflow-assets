# Visual Blueprint: character femalePerson sheet

- **Asset ID / Stem**: `character_femalePerson_sheet`
- **Category**: `units`
...
Synthesize a resolution-independent SVG vector graphic for "character femalePerson sheet" (character_femalePerson_sheet) in category "units".
