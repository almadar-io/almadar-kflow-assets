# Visual Blueprint: scifi tilesheet

- **Asset ID / Stem**: `scifi_tilesheet`
- **Category**: `terrain`
...
Synthesize a resolution-independent SVG vector graphic for "scifi tilesheet" (scifi_tilesheet) in category "terrain".
