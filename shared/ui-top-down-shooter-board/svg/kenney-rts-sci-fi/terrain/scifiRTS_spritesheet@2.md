# Visual Blueprint: scifiRTS spritesheet@2

- **Asset ID / Stem**: `scifiRTS_spritesheet@2`
- **Category**: `terrain`
- **Pack Slug**: `kenney-rts-sci-fi`
...
Synthesize a resolution-independent SVG vector graphic for "scifiRTS spritesheet@2" (scifiRTS_spritesheet@2) in category "terrain".
