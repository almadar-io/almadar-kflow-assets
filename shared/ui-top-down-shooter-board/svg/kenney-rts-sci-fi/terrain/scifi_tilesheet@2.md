# Visual Blueprint: scifi tilesheet@2

- **Asset ID / Stem**: `scifi_tilesheet@2`
- **Category**: `terrain`
...
Synthesize a resolution-independent SVG vector graphic for "scifi tilesheet@2" (scifi_tilesheet@2) in category "terrain".
