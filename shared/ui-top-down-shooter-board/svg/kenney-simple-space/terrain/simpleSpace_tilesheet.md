# Visual Blueprint: simpleSpace tilesheet

- **Asset ID / Stem**: `simpleSpace_tilesheet`
- **Category**: `terrain`
...
Synthesize a resolution-independent SVG vector graphic for "simpleSpace tilesheet" (simpleSpace_tilesheet) in category "terrain".
