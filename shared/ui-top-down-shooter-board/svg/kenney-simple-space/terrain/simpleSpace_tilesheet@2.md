# Visual Blueprint: simpleSpace tilesheet@2

- **Asset ID / Stem**: `simpleSpace_tilesheet@2`
- **Category**: `terrain`
- **Pack Slug**: `kenney-simple-space`
...
Synthesize a resolution-independent SVG vector graphic for "simpleSpace tilesheet@2" (simpleSpace_tilesheet@2) in category "terrain".
