# Visual Blueprint: simpleSpace sheet

- **Asset ID / Stem**: `simpleSpace_sheet`
- **Category**: `features`
...
Synthesize a resolution-independent SVG vector graphic for "simpleSpace sheet" (simpleSpace_sheet) in category "features".
