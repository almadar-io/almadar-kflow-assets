# Visual Blueprint: simpleSpace sheet@2

- **Asset ID / Stem**: `simpleSpace_sheet@2`
- **Category**: `features`
...
Synthesize a resolution-independent SVG vector graphic for "simpleSpace sheet@2" (simpleSpace_sheet@2) in category "features".
