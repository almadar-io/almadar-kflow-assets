# Visual Blueprint: terrainTiles default

- **Asset ID / Stem**: `terrainTiles_default`
- **Category**: `terrain`
- **Pack Slug**: `kenney-topdown-tanks-redux`
...
Synthesize a resolution-independent SVG vector graphic for "terrainTiles default" (terrainTiles_default) in category "terrain".
