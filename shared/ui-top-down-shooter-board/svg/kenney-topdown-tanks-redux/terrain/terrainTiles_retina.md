# Visual Blueprint: terrainTiles retina

- **Asset ID / Stem**: `terrainTiles_retina`
- **Category**: `terrain`
...
Synthesize a resolution-independent SVG vector graphic for "terrainTiles retina" (terrainTiles_retina) in category "terrain".
