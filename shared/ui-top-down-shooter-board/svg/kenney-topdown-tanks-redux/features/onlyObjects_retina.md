# Visual Blueprint: onlyObjects retina

- **Asset ID / Stem**: `onlyObjects_retina`
- **Category**: `features`
...
Synthesize a resolution-independent SVG vector graphic for "onlyObjects retina" (onlyObjects_retina) in category "features".
