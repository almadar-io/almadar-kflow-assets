# Visual Blueprint: allSprites default

- **Asset ID / Stem**: `allSprites_default`
- **Category**: `features`
...
Synthesize a resolution-independent SVG vector graphic for "allSprites default" (allSprites_default) in category "features".
