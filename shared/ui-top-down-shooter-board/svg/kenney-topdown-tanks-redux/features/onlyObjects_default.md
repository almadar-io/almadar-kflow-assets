# Visual Blueprint: onlyObjects default

- **Asset ID / Stem**: `onlyObjects_default`
- **Category**: `features`
...
Synthesize a resolution-independent SVG vector graphic for "onlyObjects default" (onlyObjects_default) in category "features".
