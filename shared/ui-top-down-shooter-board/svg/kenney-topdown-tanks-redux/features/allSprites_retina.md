# Visual Blueprint: allSprites retina

- **Asset ID / Stem**: `allSprites_retina`
- **Category**: `features`
...
Synthesize a resolution-independent SVG vector graphic for "allSprites retina" (allSprites_retina) in category "features".
