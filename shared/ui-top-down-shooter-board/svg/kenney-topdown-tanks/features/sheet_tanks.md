# Visual Blueprint: sheet tanks

- **Asset ID / Stem**: `sheet_tanks`
- **Category**: `features`
- **Pack Slug**: `kenney-topdown-tanks`
...
Synthesize a resolution-independent SVG vector graphic for "sheet tanks" (sheet_tanks) in category "features".
