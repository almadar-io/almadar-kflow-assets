# Visual Blueprint: roadTextures sheet

- **Asset ID / Stem**: `roadTextures_sheet`
- **Category**: `terrain`
- **Pack Slug**: `kenney-road-textures-classic`
...
Synthesize a resolution-independent SVG vector graphic for "roadTextures sheet" (roadTextures_sheet) in category "terrain".
