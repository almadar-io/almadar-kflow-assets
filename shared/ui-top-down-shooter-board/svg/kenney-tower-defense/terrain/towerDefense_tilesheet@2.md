# Visual Blueprint: towerDefense tilesheet@2

- **Asset ID / Stem**: `towerDefense_tilesheet@2`
- **Category**: `terrain`
- **Pack Slug**: `kenney-tower-defense`
...
Synthesize a resolution-independent SVG vector graphic for "towerDefense tilesheet@2" (towerDefense_tilesheet@2) in category "terrain".
