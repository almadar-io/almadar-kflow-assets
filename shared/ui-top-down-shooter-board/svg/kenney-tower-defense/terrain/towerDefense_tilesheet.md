# Visual Blueprint: towerDefense tilesheet

- **Asset ID / Stem**: `towerDefense_tilesheet`
- **Category**: `terrain`
...
Synthesize a resolution-independent SVG vector graphic for "towerDefense tilesheet" (towerDefense_tilesheet) in category "terrain".
