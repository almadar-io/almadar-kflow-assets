# Visual Blueprint: spaceShooter2 spritesheet

- **Asset ID / Stem**: `spaceShooter2_spritesheet`
- **Category**: `features`
...
Synthesize a resolution-independent SVG vector graphic for "spaceShooter2 spritesheet" (spaceShooter2_spritesheet) in category "features".
