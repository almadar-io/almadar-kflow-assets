# Visual Blueprint: spaceShooter2 spritesheet 2X

- **Asset ID / Stem**: `spaceShooter2_spritesheet_2X`
- **Category**: `features`
- **Pack Slug**: `kenney-space-shooter-extension`
...
Synthesize a resolution-independent SVG vector graphic for "spaceShooter2 spritesheet 2X" (spaceShooter2_spritesheet_2X) in category "features".
