# Visual Blueprint: tanks spritesheetRetina

- **Asset ID / Stem**: `tanks_spritesheetRetina`
- **Category**: `features`
...
Synthesize a resolution-independent SVG vector graphic for "tanks spritesheetRetina" (tanks_spritesheetRetina) in category "features".
