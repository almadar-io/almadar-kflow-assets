# Visual Blueprint: tanks spritesheetDefault

- **Asset ID / Stem**: `tanks_spritesheetDefault`
- **Category**: `features`
- **Pack Slug**: `kenney-tank-pack`
...
Synthesize a resolution-independent SVG vector graphic for "tanks spritesheetDefault" (tanks_spritesheetDefault) in category "features".
