# Visual Blueprint: ships packed

- **Asset ID / Stem**: `ships_packed`
- **Category**: `features`
- **Pack Slug**: `kenney-pixel-shmup`
...
Synthesize a resolution-independent SVG vector graphic for "ships packed" (ships_packed) in category "features".
