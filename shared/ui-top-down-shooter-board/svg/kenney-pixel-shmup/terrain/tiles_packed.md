# Visual Blueprint: tiles packed

- **Asset ID / Stem**: `tiles_packed`
- **Category**: `terrain`
...
Synthesize a resolution-independent SVG vector graphic for "tiles packed" (tiles_packed) in category "terrain".
