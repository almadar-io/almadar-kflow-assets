# Visual Blueprint: spritesheet robotsSide

- **Asset ID / Stem**: `spritesheet_robotsSide`
- **Category**: `units`
- **Pack Slug**: `kenney-robot-pack`
...
Synthesize a resolution-independent SVG vector graphic for "spritesheet robotsSide" (spritesheet_robotsSide) in category "units".
