# Visual Blueprint: spritesheet robotsTop

- **Asset ID / Stem**: `spritesheet_robotsTop`
- **Category**: `units`
...
Synthesize a resolution-independent SVG vector graphic for "spritesheet robotsTop" (spritesheet_robotsTop) in category "units".
