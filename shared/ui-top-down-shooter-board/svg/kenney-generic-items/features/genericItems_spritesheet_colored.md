# Visual Blueprint: genericItems spritesheet colored

- **Asset ID / Stem**: `genericItems_spritesheet_colored`
- **Category**: `features`
...
Synthesize a resolution-independent SVG vector graphic for "genericItems spritesheet colored" (genericItems_spritesheet_colored) in category "features".
