# Visual Blueprint: spritesheet objects

- **Asset ID / Stem**: `spritesheet_objects`
- **Category**: `features`
...
Synthesize a resolution-independent SVG vector graphic for "spritesheet objects" (spritesheet_objects) in category "features".
