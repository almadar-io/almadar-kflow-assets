# Visual Blueprint: spritesheet vehicles

- **Asset ID / Stem**: `spritesheet_vehicles`
- **Category**: `features`
...
Synthesize a resolution-independent SVG vector graphic for "spritesheet vehicles" (spritesheet_vehicles) in category "features".
