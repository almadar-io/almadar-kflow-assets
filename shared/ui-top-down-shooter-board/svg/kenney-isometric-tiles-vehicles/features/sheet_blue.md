# Visual Blueprint: sheet blue

- **Asset ID / Stem**: `sheet_blue`
- **Category**: `features`
...
Synthesize a resolution-independent SVG vector graphic for "sheet blue" (sheet_blue) in category "features".
