# Visual Blueprint: sheet black

- **Asset ID / Stem**: `sheet_black`
- **Category**: `features`
...
Synthesize a resolution-independent SVG vector graphic for "sheet black" (sheet_black) in category "features".
