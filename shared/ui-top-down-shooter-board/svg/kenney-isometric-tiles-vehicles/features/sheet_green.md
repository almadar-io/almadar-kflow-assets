# Visual Blueprint: sheet green

- **Asset ID / Stem**: `sheet_green`
- **Category**: `features`
...
Synthesize a resolution-independent SVG vector graphic for "sheet green" (sheet_green) in category "features".
