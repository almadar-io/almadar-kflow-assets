# Visual Blueprint: sheet utility

- **Asset ID / Stem**: `sheet_utility`
- **Category**: `features`
...
Synthesize a resolution-independent SVG vector graphic for "sheet utility" (sheet_utility) in category "features".
