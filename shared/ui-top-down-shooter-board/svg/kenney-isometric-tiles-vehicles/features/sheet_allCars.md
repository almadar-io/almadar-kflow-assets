# Visual Blueprint: sheet allCars

- **Asset ID / Stem**: `sheet_allCars`
- **Category**: `features`
- **Pack Slug**: `kenney-isometric-tiles-vehicles`
...
Synthesize a resolution-independent SVG vector graphic for "sheet allCars" (sheet_allCars) in category "features".
