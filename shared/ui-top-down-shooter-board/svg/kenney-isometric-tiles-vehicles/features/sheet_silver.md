# Visual Blueprint: sheet silver

- **Asset ID / Stem**: `sheet_silver`
- **Category**: `features`
...
Synthesize a resolution-independent SVG vector graphic for "sheet silver" (sheet_silver) in category "features".
