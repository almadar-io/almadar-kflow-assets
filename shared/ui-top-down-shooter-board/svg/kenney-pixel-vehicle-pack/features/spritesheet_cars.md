# Visual Blueprint: spritesheet cars

- **Asset ID / Stem**: `spritesheet_cars`
- **Category**: `features`
...
Synthesize a resolution-independent SVG vector graphic for "spritesheet cars" (spritesheet_cars) in category "features".
