# Visual Blueprint: spritesheet props

- **Asset ID / Stem**: `spritesheet_props`
- **Category**: `features`
...
Synthesize a resolution-independent SVG vector graphic for "spritesheet props" (spritesheet_props) in category "features".
