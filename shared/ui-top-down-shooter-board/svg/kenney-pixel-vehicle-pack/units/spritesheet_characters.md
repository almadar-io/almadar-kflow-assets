# Visual Blueprint: spritesheet characters

- **Asset ID / Stem**: `spritesheet_characters`
- **Category**: `units`
- **Pack Slug**: `kenney-pixel-vehicle-pack`
...
Synthesize a resolution-independent SVG vector graphic for "spritesheet characters" (spritesheet_characters) in category "units".
