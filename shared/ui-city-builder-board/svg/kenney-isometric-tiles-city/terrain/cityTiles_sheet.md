# Visual Blueprint: cityTiles sheet

- **Asset ID / Stem**: `cityTiles_sheet`
- **Category**: `terrain`
...
Synthesize a resolution-independent SVG vector graphic for "cityTiles sheet" (cityTiles_sheet) in category "terrain".
