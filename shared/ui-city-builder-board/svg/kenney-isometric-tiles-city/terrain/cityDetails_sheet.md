# Visual Blueprint: cityDetails sheet

- **Asset ID / Stem**: `cityDetails_sheet`
- **Category**: `terrain`
- **Pack Slug**: `kenney-isometric-tiles-city`
...
Synthesize a resolution-independent SVG vector graphic for "cityDetails sheet" (cityDetails_sheet) in category "terrain".
