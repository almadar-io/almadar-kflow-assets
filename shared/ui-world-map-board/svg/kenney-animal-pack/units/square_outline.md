# Visual Blueprint: square outline

- **Asset ID / Stem**: `square_outline`
- **Category**: `units`
...
Synthesize a resolution-independent SVG vector graphic for "square outline" (square_outline) in category "units".
