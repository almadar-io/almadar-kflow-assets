# Visual Blueprint: round outline

- **Asset ID / Stem**: `round_outline`
- **Category**: `units`
...
Synthesize a resolution-independent SVG vector graphic for "round outline" (round_outline) in category "units".
