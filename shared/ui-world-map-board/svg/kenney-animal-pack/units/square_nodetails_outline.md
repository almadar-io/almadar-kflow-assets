# Visual Blueprint: square nodetails outline

- **Asset ID / Stem**: `square_nodetails_outline`
- **Category**: `units`
- **Pack Slug**: `kenney-animal-pack`
...
Synthesize a resolution-independent SVG vector graphic for "square nodetails outline" (square_nodetails_outline) in category "units".
