# Visual Blueprint: round nodetails outline

- **Asset ID / Stem**: `round_nodetails_outline`
- **Category**: `units`
...
Synthesize a resolution-independent SVG vector graphic for "round nodetails outline" (round_nodetails_outline) in category "units".
