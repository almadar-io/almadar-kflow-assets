# Visual Blueprint: square nodetails

- **Asset ID / Stem**: `square_nodetails`
- **Category**: `units`
...
Synthesize a resolution-independent SVG vector graphic for "square nodetails" (square_nodetails) in category "units".
