# Visual Blueprint: round nodetails

- **Asset ID / Stem**: `round_nodetails`
- **Category**: `units`
...
Synthesize a resolution-independent SVG vector graphic for "round nodetails" (round_nodetails) in category "units".
