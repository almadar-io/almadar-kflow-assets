# Visual Blueprint: roundOutline

- **Asset ID / Stem**: `roundOutline`
- **Category**: `units`
...
Synthesize a resolution-independent SVG vector graphic for "roundOutline" (roundOutline) in category "units".
