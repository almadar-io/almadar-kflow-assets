# Visual Blueprint: square nodetailsOutline

- **Asset ID / Stem**: `square_nodetailsOutline`
- **Category**: `units`
- **Pack Slug**: `kenney-animal-pack-redux`
- **Board Genre**: `ui-world-map-board`
...
Synthesize a resolution-independent SVG vector graphic for "square nodetailsOutline" (square_nodetailsOutline) in category "units".
