# Visual Blueprint: squareOutline

- **Asset ID / Stem**: `squareOutline`
- **Category**: `units`
...
Synthesize a resolution-independent SVG vector graphic for "squareOutline" (squareOutline) in category "units".
