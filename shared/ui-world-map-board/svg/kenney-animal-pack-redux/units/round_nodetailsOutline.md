# Visual Blueprint: round nodetailsOutline

- **Asset ID / Stem**: `round_nodetailsOutline`
- **Category**: `units`
...
Synthesize a resolution-independent SVG vector graphic for "round nodetailsOutline" (round_nodetailsOutline) in category "units".
