# Visual Blueprint: sokoban spritesheet@2

- **Asset ID / Stem**: `sokoban_spritesheet@2`
- **Category**: `terrain`
- **Pack Slug**: `kenney-sokoban-pack`
- **Board Genre**: `ui-pinball-board`
...
Synthesize a resolution-independent SVG vector graphic for "sokoban spritesheet@2" (sokoban_spritesheet@2) in category "terrain".
