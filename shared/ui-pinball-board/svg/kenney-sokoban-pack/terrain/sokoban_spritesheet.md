# Visual Blueprint: sokoban spritesheet

- **Asset ID / Stem**: `sokoban_spritesheet`
- **Category**: `terrain`
...
Synthesize a resolution-independent SVG vector graphic for "sokoban spritesheet" (sokoban_spritesheet) in category "terrain".
