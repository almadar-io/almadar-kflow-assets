# Visual Blueprint: sokoban tilesheet

- **Asset ID / Stem**: `sokoban_tilesheet`
- **Category**: `terrain`
...
Synthesize a resolution-independent SVG vector graphic for "sokoban tilesheet" (sokoban_tilesheet) in category "terrain".
