# Visual Blueprint: nautical tilesheet

- **Asset ID / Stem**: `nautical_tilesheet`
- **Category**: `terrain`
...
Synthesize a resolution-independent SVG vector graphic for "nautical tilesheet" (nautical_tilesheet) in category "terrain".
