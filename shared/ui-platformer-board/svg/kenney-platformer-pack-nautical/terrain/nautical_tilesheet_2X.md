# Visual Blueprint: nautical tilesheet 2X

- **Asset ID / Stem**: `nautical_tilesheet_2X`
- **Category**: `terrain`
- **Pack Slug**: `kenney-platformer-pack-nautical`
...
Synthesize a resolution-independent SVG vector graphic for "nautical tilesheet 2X" (nautical_tilesheet_2X) in category "terrain".
