# Visual Blueprint: nautical spritesheet

- **Asset ID / Stem**: `nautical_spritesheet`
- **Category**: `terrain`
...
Synthesize a resolution-independent SVG vector graphic for "nautical spritesheet" (nautical_spritesheet) in category "terrain".
