# Visual Blueprint: medieval tilesheet 2X

- **Asset ID / Stem**: `medieval_tilesheet_2X`
- **Category**: `terrain`
- **Pack Slug**: `kenney-platformer-pack-medieval`
...
Synthesize a resolution-independent SVG vector graphic for "medieval tilesheet 2X" (medieval_tilesheet_2X) in category "terrain".
