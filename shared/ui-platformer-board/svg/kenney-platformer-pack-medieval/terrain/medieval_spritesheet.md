# Visual Blueprint: medieval spritesheet

- **Asset ID / Stem**: `medieval_spritesheet`
- **Category**: `terrain`
...
Synthesize a resolution-independent SVG vector graphic for "medieval spritesheet" (medieval_spritesheet) in category "terrain".
