...
- **Asset ID / Stem**: `spritesheet_double`
- **Category**: `features`
...
Card rank "SPR" displayed in top-left and bottom-right corners with large central suit emblem symbol for spritesheet double.
...
Synthesize a resolution-independent SVG vector graphic for "spritesheet double" (spritesheet_double) in category "features".
...
Surface & Details: Card rank "SPR" displayed in top-left and bottom-right corners with large central suit emblem symbol for spritesheet double.
