# Visual Blueprint: diceRed border

- **Asset ID / Stem**: `diceRed_border`
- **Category**: `ui`
...
Card rank "DIC" displayed in top-left and bottom-right corners with large central suit emblem symbol for diceRed border.
...
Synthesize a resolution-independent SVG vector graphic for "diceRed border" (diceRed_border) in category "ui".
...
Surface & Details: Card rank "DIC" displayed in top-left and bottom-right corners with large central suit emblem symbol for diceRed border.
Color Scheme: Primary #EF4444, Secondary #DC2626, Shadow #0369A1, Highlight #BAE6FD, Outline #1E293B.
