# Visual Blueprint: diceWhite border

- **Asset ID / Stem**: `diceWhite_border`
- **Category**: `ui`
- **Pack Slug**: `kenney-boardgame-pack`
...
Card rank "DIC" displayed in top-left and bottom-right corners with large central suit emblem symbol for diceWhite border.
...
Synthesize a resolution-independent SVG vector graphic for "diceWhite border" (diceWhite_border) in category "ui".
...
Surface & Details: Card rank "DIC" displayed in top-left and bottom-right corners with large central suit emblem symbol for diceWhite border.
