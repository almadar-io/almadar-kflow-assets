# Visual Blueprint: playingCardBacks

- **Asset ID / Stem**: `playingCardBacks`
- **Category**: `features`
...
Card rank "PLA" displayed in top-left and bottom-right corners with large central suit emblem symbol for playingCardBacks.
...
Synthesize a resolution-independent SVG vector graphic for "playingCardBacks" (playingCardBacks) in category "features".
...
Surface & Details: Card rank "PLA" displayed in top-left and bottom-right corners with large central suit emblem symbol for playingCardBacks.
