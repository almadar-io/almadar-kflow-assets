# Visual Blueprint: playingCards

- **Asset ID / Stem**: `playingCards`
- **Category**: `features`
...
Card rank "PLA" displayed in top-left and bottom-right corners with large central suit emblem symbol for playingCards.
...
Synthesize a resolution-independent SVG vector graphic for "playingCards" (playingCards) in category "features".
...
Surface & Details: Card rank "PLA" displayed in top-left and bottom-right corners with large central suit emblem symbol for playingCards.
