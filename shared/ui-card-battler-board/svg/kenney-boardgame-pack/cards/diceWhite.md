# Visual Blueprint: diceWhite

- **Asset ID / Stem**: `diceWhite`
- **Category**: `cards`
...
Card rank "DIC" displayed in top-left and bottom-right corners with large central suit emblem symbol for diceWhite.
...
Synthesize a resolution-independent SVG vector graphic for "diceWhite" (diceWhite) in category "cards".
...
Surface & Details: Card rank "DIC" displayed in top-left and bottom-right corners with large central suit emblem symbol for diceWhite.
