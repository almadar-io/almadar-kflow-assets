# Visual Blueprint: diceRed

- **Asset ID / Stem**: `diceRed`
- **Category**: `cards`
...
Card rank "DIC" displayed in top-left and bottom-right corners with large central suit emblem symbol for diceRed.
...
Synthesize a resolution-independent SVG vector graphic for "diceRed" (diceRed) in category "cards".
...
Surface & Details: Card rank "DIC" displayed in top-left and bottom-right corners with large central suit emblem symbol for diceRed.
