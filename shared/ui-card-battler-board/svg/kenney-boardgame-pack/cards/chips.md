...
Card rank "CHI" displayed in top-left and bottom-right corners with large central suit emblem symbol for chips.
...
Synthesize a resolution-independent SVG vector graphic for "chips" (chips) in category "cards".
...
Surface & Details: Card rank "CHI" displayed in top-left and bottom-right corners with large central suit emblem symbol for chips.
