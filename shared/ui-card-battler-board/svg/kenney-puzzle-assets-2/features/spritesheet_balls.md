# Visual Blueprint: spritesheet balls

- **Asset ID / Stem**: `spritesheet_balls`
- **Category**: `features`
...
Card rank "SPR" displayed in top-left and bottom-right corners with large central suit emblem symbol for spritesheet balls.
...
Synthesize a resolution-independent SVG vector graphic for "spritesheet balls" (spritesheet_balls) in category "features".
...
Surface & Details: Card rank "SPR" displayed in top-left and bottom-right corners with large central suit emblem symbol for spritesheet balls.
