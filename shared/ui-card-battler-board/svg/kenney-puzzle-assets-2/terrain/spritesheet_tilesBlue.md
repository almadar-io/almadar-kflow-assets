# Visual Blueprint: spritesheet tilesBlue

- **Asset ID / Stem**: `spritesheet_tilesBlue`
- **Category**: `terrain`
...
Card rank "SPR" displayed in top-left and bottom-right corners with large central suit emblem symbol for spritesheet tilesBlue.
...
Synthesize a resolution-independent SVG vector graphic for "spritesheet tilesBlue" (spritesheet_tilesBlue) in category "terrain".
...
Surface & Details: Card rank "SPR" displayed in top-left and bottom-right corners with large central suit emblem symbol for spritesheet tilesBlue.
