# Visual Blueprint: rollingBall sheet

- **Asset ID / Stem**: `rollingBall_sheet`
- **Category**: `features`
...
Card rank "ROL" displayed in top-left and bottom-right corners with large central suit emblem symbol for rollingBall sheet.
...
Synthesize a resolution-independent SVG vector graphic for "rollingBall sheet" (rollingBall_sheet) in category "features".
...
Surface & Details: Card rank "ROL" displayed in top-left and bottom-right corners with large central suit emblem symbol for rollingBall sheet.
