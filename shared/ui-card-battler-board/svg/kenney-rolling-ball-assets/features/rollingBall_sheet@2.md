# Visual Blueprint: rollingBall sheet@2

- **Asset ID / Stem**: `rollingBall_sheet@2`
- **Category**: `features`
- **Pack Slug**: `kenney-rolling-ball-assets`
...
Card rank "ROL" displayed in top-left and bottom-right corners with large central suit emblem symbol for rollingBall sheet@2.
...
Synthesize a resolution-independent SVG vector graphic for "rollingBall sheet@2" (rollingBall_sheet@2) in category "features".
...
Surface & Details: Card rank "ROL" displayed in top-left and bottom-right corners with large central suit emblem symbol for rollingBall sheet@2.
