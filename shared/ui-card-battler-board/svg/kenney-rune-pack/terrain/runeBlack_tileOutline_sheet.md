# Visual Blueprint: runeBlack tileOutline sheet

- **Asset ID / Stem**: `runeBlack_tileOutline_sheet`
- **Category**: `terrain`
...
Card rank "RUN" displayed in top-left and bottom-right corners with large central suit emblem symbol for runeBlack tileOutline sheet.
...
Synthesize a resolution-independent SVG vector graphic for "runeBlack tileOutline sheet" (runeBlack_tileOutline_sheet) in category "terrain".
...
Surface & Details: Card rank "RUN" displayed in top-left and bottom-right corners with large central suit emblem symbol for runeBlack tileOutline sheet.
