# Visual Blueprint: runeGrey tile sheet

- **Asset ID / Stem**: `runeGrey_tile_sheet`
- **Category**: `terrain`
...
Card rank "RUN" displayed in top-left and bottom-right corners with large central suit emblem symbol for runeGrey tile sheet.
...
Synthesize a resolution-independent SVG vector graphic for "runeGrey tile sheet" (runeGrey_tile_sheet) in category "terrain".
...
Surface & Details: Card rank "RUN" displayed in top-left and bottom-right corners with large central suit emblem symbol for runeGrey tile sheet.
