# Visual Blueprint: runeBlue tile sheet

- **Asset ID / Stem**: `runeBlue_tile_sheet`
- **Category**: `terrain`
...
Card rank "RUN" displayed in top-left and bottom-right corners with large central suit emblem symbol for runeBlue tile sheet.
...
Synthesize a resolution-independent SVG vector graphic for "runeBlue tile sheet" (runeBlue_tile_sheet) in category "terrain".
...
Surface & Details: Card rank "RUN" displayed in top-left and bottom-right corners with large central suit emblem symbol for runeBlue tile sheet.
