# Visual Blueprint: runeGrey tileOutline sheet

- **Asset ID / Stem**: `runeGrey_tileOutline_sheet`
- **Category**: `terrain`
...
Card rank "RUN" displayed in top-left and bottom-right corners with large central suit emblem symbol for runeGrey tileOutline sheet.
...
Synthesize a resolution-independent SVG vector graphic for "runeGrey tileOutline sheet" (runeGrey_tileOutline_sheet) in category "terrain".
...
Surface & Details: Card rank "RUN" displayed in top-left and bottom-right corners with large central suit emblem symbol for runeGrey tileOutline sheet.
