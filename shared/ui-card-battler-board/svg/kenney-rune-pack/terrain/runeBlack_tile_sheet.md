# Visual Blueprint: runeBlack tile sheet

- **Asset ID / Stem**: `runeBlack_tile_sheet`
- **Category**: `terrain`
...
Card rank "RUN" displayed in top-left and bottom-right corners with large central suit emblem symbol for runeBlack tile sheet.
...
Synthesize a resolution-independent SVG vector graphic for "runeBlack tile sheet" (runeBlack_tile_sheet) in category "terrain".
...
Surface & Details: Card rank "RUN" displayed in top-left and bottom-right corners with large central suit emblem symbol for runeBlack tile sheet.
