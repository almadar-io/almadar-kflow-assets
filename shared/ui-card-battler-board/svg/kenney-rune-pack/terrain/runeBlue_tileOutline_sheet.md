# Visual Blueprint: runeBlue tileOutline sheet

- **Asset ID / Stem**: `runeBlue_tileOutline_sheet`
- **Category**: `terrain`
...
Card rank "RUN" displayed in top-left and bottom-right corners with large central suit emblem symbol for runeBlue tileOutline sheet.
...
Synthesize a resolution-independent SVG vector graphic for "runeBlue tileOutline sheet" (runeBlue_tileOutline_sheet) in category "terrain".
...
Surface & Details: Card rank "RUN" displayed in top-left and bottom-right corners with large central suit emblem symbol for runeBlue tileOutline sheet.
