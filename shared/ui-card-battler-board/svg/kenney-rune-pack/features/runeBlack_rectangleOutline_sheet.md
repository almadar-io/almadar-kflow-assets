# Visual Blueprint: runeBlack rectangleOutline sheet

- **Asset ID / Stem**: `runeBlack_rectangleOutline_sheet`
- **Category**: `features`
- **Pack Slug**: `kenney-rune-pack`
...
Card rank "RUN" displayed in top-left and bottom-right corners with large central suit emblem symbol for runeBlack rectangleOutline sheet.
...
Synthesize a resolution-independent SVG vector graphic for "runeBlack rectangleOutline sheet" (runeBlack_rectangleOutline_sheet) in category "features".
...
Surface & Details: Card rank "RUN" displayed in top-left and bottom-right corners with large central suit emblem symbol for runeBlack rectangleOutline sheet.
Color Scheme: Primary #1E293B, Secondary #0F172A, Shadow #0F172A, Highlight #64748B, Outline #1E293B.
