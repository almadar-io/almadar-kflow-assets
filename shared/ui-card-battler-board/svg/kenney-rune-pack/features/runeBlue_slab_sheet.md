# Visual Blueprint: runeBlue slab sheet

- **Asset ID / Stem**: `runeBlue_slab_sheet`
- **Category**: `features`
...
Card rank "RUN" displayed in top-left and bottom-right corners with large central suit emblem symbol for runeBlue slab sheet.
...
Synthesize a resolution-independent SVG vector graphic for "runeBlue slab sheet" (runeBlue_slab_sheet) in category "features".
...
Surface & Details: Card rank "RUN" displayed in top-left and bottom-right corners with large central suit emblem symbol for runeBlue slab sheet.
