# Visual Blueprint: runeGrey slab sheet

- **Asset ID / Stem**: `runeGrey_slab_sheet`
- **Category**: `features`
...
Card rank "RUN" displayed in top-left and bottom-right corners with large central suit emblem symbol for runeGrey slab sheet.
...
Synthesize a resolution-independent SVG vector graphic for "runeGrey slab sheet" (runeGrey_slab_sheet) in category "features".
...
Surface & Details: Card rank "RUN" displayed in top-left and bottom-right corners with large central suit emblem symbol for runeGrey slab sheet.
