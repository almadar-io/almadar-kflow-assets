# Visual Blueprint: runeBlack rectangle sheet

- **Asset ID / Stem**: `runeBlack_rectangle_sheet`
- **Category**: `features`
...
Card rank "RUN" displayed in top-left and bottom-right corners with large central suit emblem symbol for runeBlack rectangle sheet.
...
Synthesize a resolution-independent SVG vector graphic for "runeBlack rectangle sheet" (runeBlack_rectangle_sheet) in category "features".
...
Surface & Details: Card rank "RUN" displayed in top-left and bottom-right corners with large central suit emblem symbol for runeBlack rectangle sheet.
