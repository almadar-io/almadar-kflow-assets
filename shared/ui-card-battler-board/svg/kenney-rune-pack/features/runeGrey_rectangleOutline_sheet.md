# Visual Blueprint: runeGrey rectangleOutline sheet

- **Asset ID / Stem**: `runeGrey_rectangleOutline_sheet`
- **Category**: `features`
...
Card rank "RUN" displayed in top-left and bottom-right corners with large central suit emblem symbol for runeGrey rectangleOutline sheet.
...
Synthesize a resolution-independent SVG vector graphic for "runeGrey rectangleOutline sheet" (runeGrey_rectangleOutline_sheet) in category "features".
...
Surface & Details: Card rank "RUN" displayed in top-left and bottom-right corners with large central suit emblem symbol for runeGrey rectangleOutline sheet.
Color Scheme: Primary #1E293B, Secondary #0F172A, Shadow #334155, Highlight #CBD5E1, Outline #1E293B.
