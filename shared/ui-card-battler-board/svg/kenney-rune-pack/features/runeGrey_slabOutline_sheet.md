# Visual Blueprint: runeGrey slabOutline sheet

- **Asset ID / Stem**: `runeGrey_slabOutline_sheet`
- **Category**: `features`
...
Card rank "RUN" displayed in top-left and bottom-right corners with large central suit emblem symbol for runeGrey slabOutline sheet.
...
Synthesize a resolution-independent SVG vector graphic for "runeGrey slabOutline sheet" (runeGrey_slabOutline_sheet) in category "features".
...
Surface & Details: Card rank "RUN" displayed in top-left and bottom-right corners with large central suit emblem symbol for runeGrey slabOutline sheet.
