# Visual Blueprint: runeBlue rectangleOutline sheet

- **Asset ID / Stem**: `runeBlue_rectangleOutline_sheet`
- **Category**: `features`
...
Card rank "RUN" displayed in top-left and bottom-right corners with large central suit emblem symbol for runeBlue rectangleOutline sheet.
...
Synthesize a resolution-independent SVG vector graphic for "runeBlue rectangleOutline sheet" (runeBlue_rectangleOutline_sheet) in category "features".
...
Surface & Details: Card rank "RUN" displayed in top-left and bottom-right corners with large central suit emblem symbol for runeBlue rectangleOutline sheet.
Color Scheme: Primary #1E293B, Secondary #0F172A, Shadow #0369A1, Highlight #BAE6FD, Outline #1E293B.
