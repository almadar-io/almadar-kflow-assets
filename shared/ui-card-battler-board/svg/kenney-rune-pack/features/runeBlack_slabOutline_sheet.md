# Visual Blueprint: runeBlack slabOutline sheet

- **Asset ID / Stem**: `runeBlack_slabOutline_sheet`
- **Category**: `features`
...
Card rank "RUN" displayed in top-left and bottom-right corners with large central suit emblem symbol for runeBlack slabOutline sheet.
...
Synthesize a resolution-independent SVG vector graphic for "runeBlack slabOutline sheet" (runeBlack_slabOutline_sheet) in category "features".
...
Surface & Details: Card rank "RUN" displayed in top-left and bottom-right corners with large central suit emblem symbol for runeBlack slabOutline sheet.
