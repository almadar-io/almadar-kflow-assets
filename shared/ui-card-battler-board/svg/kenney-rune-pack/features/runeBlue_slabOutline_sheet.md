# Visual Blueprint: runeBlue slabOutline sheet

- **Asset ID / Stem**: `runeBlue_slabOutline_sheet`
- **Category**: `features`
...
Card rank "RUN" displayed in top-left and bottom-right corners with large central suit emblem symbol for runeBlue slabOutline sheet.
...
Synthesize a resolution-independent SVG vector graphic for "runeBlue slabOutline sheet" (runeBlue_slabOutline_sheet) in category "features".
...
Surface & Details: Card rank "RUN" displayed in top-left and bottom-right corners with large central suit emblem symbol for runeBlue slabOutline sheet.
