# Visual Blueprint: runeBlue rectangle sheet

- **Asset ID / Stem**: `runeBlue_rectangle_sheet`
- **Category**: `features`
...
Card rank "RUN" displayed in top-left and bottom-right corners with large central suit emblem symbol for runeBlue rectangle sheet.
...
Synthesize a resolution-independent SVG vector graphic for "runeBlue rectangle sheet" (runeBlue_rectangle_sheet) in category "features".
...
Surface & Details: Card rank "RUN" displayed in top-left and bottom-right corners with large central suit emblem symbol for runeBlue rectangle sheet.
