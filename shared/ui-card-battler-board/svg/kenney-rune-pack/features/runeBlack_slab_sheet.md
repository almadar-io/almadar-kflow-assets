# Visual Blueprint: runeBlack slab sheet

- **Asset ID / Stem**: `runeBlack_slab_sheet`
- **Category**: `features`
...
Card rank "RUN" displayed in top-left and bottom-right corners with large central suit emblem symbol for runeBlack slab sheet.
...
Synthesize a resolution-independent SVG vector graphic for "runeBlack slab sheet" (runeBlack_slab_sheet) in category "features".
...
Surface & Details: Card rank "RUN" displayed in top-left and bottom-right corners with large central suit emblem symbol for runeBlack slab sheet.
