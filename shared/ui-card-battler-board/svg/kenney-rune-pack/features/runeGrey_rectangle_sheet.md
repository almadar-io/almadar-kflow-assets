# Visual Blueprint: runeGrey rectangle sheet

- **Asset ID / Stem**: `runeGrey_rectangle_sheet`
- **Category**: `features`
...
Card rank "RUN" displayed in top-left and bottom-right corners with large central suit emblem symbol for runeGrey rectangle sheet.
...
Synthesize a resolution-independent SVG vector graphic for "runeGrey rectangle sheet" (runeGrey_rectangle_sheet) in category "features".
...
Surface & Details: Card rank "RUN" displayed in top-left and bottom-right corners with large central suit emblem symbol for runeGrey rectangle sheet.
