# Visual Blueprint: metalPanel blue

- **Asset ID / Stem**: `metalPanel_blue`
- **Category**: `ui`
- **Pack Slug**: `kenney-ui-pack-sci-fi`
...
Synthesize a resolution-independent SVG vector graphic for "metalPanel blue" (metalPanel_blue) in category "ui".
