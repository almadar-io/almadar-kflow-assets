# Visual Blueprint: grey button00

- **Asset ID / Stem**: `grey_button00`
- **Category**: `ui`
- **Pack Slug**: `kenney-ui-pack`
...
Synthesize a resolution-independent SVG vector graphic for "grey button00" (grey_button00) in category "ui".
