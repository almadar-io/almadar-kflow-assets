# Visual Blueprint: panel brownimg

- **Asset ID / Stem**: `panel_brownimg`
- **Category**: `ui`
- **Pack Slug**: `kenney-ui-pack-adventure`
...
Synthesize a resolution-independent SVG vector graphic for "panel brownimg" (panel_brownimg) in category "ui".
