# Visual Blueprint: panel brown

- **Asset ID / Stem**: `panel_brown`
- **Category**: `ui`
...
Synthesize a resolution-independent SVG vector graphic for "panel brown" (panel_brown) in category "ui".
