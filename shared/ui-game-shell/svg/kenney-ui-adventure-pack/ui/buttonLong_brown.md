# Visual Blueprint: buttonLong brown

- **Asset ID / Stem**: `buttonLong_brown`
- **Category**: `ui`
- **Pack Slug**: `kenney-ui-adventure-pack`
- **Board Genre**: `ui-game-shell`
...
Synthesize a resolution-independent SVG vector graphic for "buttonLong brown" (buttonLong_brown) in category "ui".
